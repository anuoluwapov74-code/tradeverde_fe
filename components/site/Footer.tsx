      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="mt-8 border-t border-[var(--border)] pt-8">
          <div className="space-y-4 text-xs leading-relaxed text-[var(--foreground-muted)]">
            <p>
              Disclaimer: VERDE VENTURES, LLC ( CRD # 331287/SEC#:802-130592 ), a
              ...
              referenced registration numbers. VERDE VENTURES, LLC is a duly
              ...
              indices, and digital assets. VERDE VENTURES, LLC operates across
            ...
            <p>
              ...
              Under no circumstances shall VERDE VENTURES, LLC have any liability to any
              ...
              VERDE VENTURES, LLC by following and/or copying or replicating the trades
              ...
              performance of a VERDE VENTURES, LLC Community Member is not a reliable
              indicator of his future performance. Content on VERDE VENTURES, LLC&apos;s
              ...
              VERDE VENTURES, LLC- Your Social Investment Network.
            </p>
            <p className="pt-4">
              Copyright &copy; 2006-2026 VERDE VENTURES, LLC - Your Social Investment Network,
              All rights reserved.
            </p>
          </div>
        </div>
