      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          <div className="lg:col-span-3">
            <div className="mb-4">
              <span className="text-2xl font-bold">
                <span className="text-[var(--primary)]">Verdes</span>Trades
              </span>
            </div>
            <p className="mb-4 text-sm text-[var(--foreground-muted)]">
              Copy trade with VerdesTrades
            </p>
        ...
        <div className="mt-8 border-t border-[var(--border)] pt-8">
          <div className="space-y-4 text-xs leading-relaxed text-[var(--foreground-muted)]">
            <p>
              Disclaimer: VERDESTRADES ( CRD # 147179/SEC#:801-69167 ), a
              ...
              referenced registration numbers. VERDESTRADES is a duly
              ...
              indices, and digital assets. VERDESTRADES operates across
              ...
              VERDESTRADES is committed to full regulatory compliance and the
            ...
            <p>
              ...
              Under no circumstances shall VERDESTRADES have any liability to any
              ...
              VERDESTRADES by following and/or copying or replicating the trades
              ...
              performance of a VERDESTRADES Community Member is not a reliable
              indicator of his future performance. Content on VERDESTRADES&apos;s
              ...
              VERDESTRADES - Your Social Investment Network.
            </p>
            <p className="pt-4">
              Copyright &copy; 2006-2026 VERDESTRADES - Your Social Investment Network,
              All rights reserved.
            </p>
          </div>
        </div>
